...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==================== Places Page Logic ====================
    // Only run on pages with #places-list (index.html)
    const placesList = document.getElementById('places-list');
    if (!placesList) return; // Not on index page, exit
    ...
    if (!token) {
        ...
        // Optionally hide filter if not logged in? We'll leave it visible but empty.
        if (priceFilter) priceFilter.disabled = true;
    } else {
        console.log('Token found, hiding login link');
